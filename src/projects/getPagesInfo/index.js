...
const pageUsernameInput =
  require("D:/PrivateConfings/Puppeteer4Fun/configs").pageUsername;
const pageUserpwdInput =
  require("D:/PrivateConfings/Puppeteer4Fun/configs").pageUserpwd;
...
async function crawler() {
  ...
  // 打开新的链接
  await page.click(
    "#deskList > div.box2 > div.cell.clearfix > div:nth-child(4)"
  );
  console.time("打开新的链接");
  await page.waitFor(1000 * 5);
  ...
  Tools.writeFile("./rec.js", JSON.stringify(recObj))
    .then((r) => {
      chalk.green(r);
    })
    .catch((error) => {
